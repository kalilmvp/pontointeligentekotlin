...
class CadastroPJControllerTest{
    ...
    private val urlBase: String = "/api/cadastrar-pj"
    ...
    fun adicionarTest(){
        ...
        BDDMockito.given(this.empresaService?.persistir(empresa)).willReturn(empresa)
    ...
    @Throws(Exception::class)
    @WithMockUser
    fun adicionarPjComEmpresaJaCadastradaTest(){
        val funcionario: Funcionario = funcionario()
        val empresa = empresa()
        ...
        mockMvc!!.perform(MockMvcRequestBuilders.post(urlBase)
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.erros").value("Empresa já existente."))
    ...
    @Throws(Exception::class)
    @WithMockUser
    fun adicionarPJComCPFJaExistenteTest(){
        val funcionario: Funcionario = funcionario()
        val empresa = empresa()
    ...
    fun adicionarPFComEmailJaCadastradoTest(){
        ...
        BDDMockito.given(this.empresaService?.findByCnpj(CNPJ)).willReturn(null)
        BDDMockito.given(this.funcionarioService?.buscarPorCpf(funcionario.cpf)).willReturn(null)
    ...
    private fun obterJsonRequisicaoPost(funcionario: Funcionario, empresa: Empresa): String {
        return ObjectMapper().writeValueAsString(
                CadastroPjDTO(funcionario.nome, funcionario.email, SenhaUtils().gerarBCrypt("123456"),
